class PostsController < ApplicationController
  ...
  def update
    ...
    the_post.title = params.fetch("_title")
    the_post.body = params.fetch("_body")
    the_post.expires_on = params.fetch("_expires_on")
    the_post.board_id = params.fetch("_board_id")
